...
def cnn3(input_shape: Tuple[int, ...]) -> nn.Module:
    ...
    class Classifier(nn.Module):
        def __init__(self):
            ...
            self.cnn1 = nn.Conv2d(in_channels=input_c, out_channels=16, kernel_size=3, stride=1, padding=1)
            ...
            self.cnn5 = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=3, stride=1, padding=1)
